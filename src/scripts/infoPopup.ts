...
export default class InfoScene extends Scene{
    ...
    createPages() {
        ...
        const Heading = this.add.text(960, 330, "MINOR SYMBOLS", {fontFamily:"Sava", color:"#632e2e", fontSize:"50px"}).setOrigin(0.5)

        const tripple7 = this.add.sprite(550, 450, "slots0_0").setOrigin(0.5).setScale(0.8)
        const tripple7StaticText = this.add.text(500, 520, `3X`, {fontFamily:"Sava", fontSize:"40px", color: "#632e2e", wordWrap:{ width: 300, useAdvancedWrap: true }}).setOrigin(0.5)
        // const tripple7Text = this.add.text(570, 520, ` ${initData.UIData.symbols[1].payout}`, {fontFamily:"Sava", fontSize:"40px", color: "#632e2e", wordWrap:{ width: 300, useAdvancedWrap: true }}).setOrigin(0.5)
        const  double7 = this.add.sprite(960, 450, "slots1_0").setOrigin(0.5).setScale(0.8);
        const double7StaticText = this.add.text(920, 520, `3X`, {fontFamily: "Sava", fontSize: "40px", color:"#632e2e"}).setOrigin(0.5);
        // const double7Text = this.add.text(990, 520, ` ${initData.UIData.symbols[2].payout}`, {fontFamily:"Sava", fontSize:"40px", color: "#632e2e", wordWrap:{ width: 300, useAdvancedWrap: true }}).setOrigin(0.5)
        const singleSeven = this.add.sprite(1370, 450, "slots2_0").setOrigin(0.5).setScale(0.8);
        const singleSevenStaticText = this.add.text(1340, 520, `3X`, {fontFamily: "Sava", fontSize: "40px", color:"#632e2e"}).setOrigin(0.5);
        // const singleSevenText = this.add.text(1390, 520, ` ${initData.UIData.symbols[3].payout}`, {fontFamily: "Sava", fontSize:"40px", color:"#632e2e"}).setOrigin(0.5);
        const fiveBar = this.add.sprite(550, 680, "slots3_0").setOrigin(0.5).setScale(0.8)
        const fiveBarStaticText = this.add.text(520, 780, `3X`, {fontFamily: "Sava", fontSize: "40px", color:"#632e2e"}).setOrigin(0.5);
        // const fiveBarText = this.add.text(570, 780, ` ${initData.UIData.symbols[4].payout}`, {fontFamily: "Sava", fontSize:"40px", color:"#632e2e"}).setOrigin(0.5)
        const bar = this.add.sprite(960, 680, "slots4_0").setOrigin(0.5).setScale(0.8)
        const barStaticText = this.add.text(930, 780, `3X`, {fontFamily:"Sava", fontSize:"40px", color:"#632e2e"}).setOrigin(0.5);
        // const barText = this.add.text(980, 780, ` ${initData.UIData.symbols[5].payout}`,{fontFamily:"Sava", fontSize:"40px", color:"#632e2e"}).setOrigin(0.5)
        // const wheelSeven = this.add.sprite(1370, 680, "slots12_0").setOrigin(0.5).setScale(0.8)
        // const wheelSevenStaticText = this.add.text(1320, 780, `3X`, {fontFamily: "Sava", fontSize: "40px", color:"#632e2e"}).setOrigin(0.5);
        // const wheelSevenText = this.add.text(1390, 780, ` ${initData.UIData.symbols[11].payout}`, {fontFamily:"Sava", fontSize:"40px", color:"#632e2e"}).setOrigin(0.5)

        this.pages[1].add([Heading, tripple7, tripple7StaticText, double7, double7StaticText, singleSeven, singleSevenStaticText, fiveBar, fiveBarStaticText, bar, barStaticText])
        this.pageviewContainer.add(this.pages[1]);

        this.pages[2] = this.add.container(0, 0);  // Position off-screen initially
        const specialHeading = this.add.text(this.scale.width/2, 320, "Special Symbols", {fontFamily:"Sava", color: "#632e2e", fontSize: "50px"}).setOrigin(0.5)
        const goldSprite = this.add.sprite(650, 450, "slots12_0").setOrigin(0.5).setScale(0.8)
        const bonusText = this.add.text(650, 600, `Any 2X - triggers bonus game. Tap the spin button to spin the wheel and get exciting reward`, {fontFamily:"Sava", fontSize:"35px", color: "#632e2e", wordWrap:{ width: 350, useAdvancedWrap: true }}).setOrigin(0.5)
        ...
        const payTableImage = this.add.text(gameConfig.scale.width/2, 320, "Payout", {fontFamily:"Sava", color: "#632e2e", fontSize: "50px"}).setOrigin(0.5)
        const firstAnySprite = this.add.sprite(720, 450, "firstAny").setScale(0.6).setOrigin(0.5);
        const firstAnyStatic =  this.add.text(650, 520, "Any 3X - ", {fontFamily: "Sava", fontSize: "40px", color:"#632e2e"}).setOrigin(0.5)
        const firstAnyText =  this.add.text(760, 520, "12X", {fontFamily: "Sava", fontSize: "40px", color:"#632e2e"}).setOrigin(0.5)
        const secondAnySprite = this.add.sprite(1300, 450, "secondAny").setScale(0.6).setOrigin(0.5)
        const secondAnyStatic = this.add.text(1250, 520, "Any 3X - ", {fontFamily: "Sava", fontSize: "40px", color:"#632e2e"}).setOrigin(0.5);
        const secondAnyText = this.add.text(1355, 520, "8X", {fontFamily: "Sava", fontSize: "40px", color:"#632e2e"}).setOrigin(0.5);

        const thirdAnySprite = this.add.sprite(gameConfig.scale.width/2, 680, "thirdAny").setScale(0.65).setOrigin(0.5);
        const thirdAnyStatic = this.add.text(900, 780, "Any 3X - ", {fontFamily: "Sava", fontSize: "40px", color:"#632e2e"}).setOrigin(0.5);
        const thirdAnyText = this.add.text(1010, 780, "10X", {fontFamily: "Sava", fontSize: "40px", color:"#632e2e"}).setOrigin(0.5);
        ...
        const freeSpinHeading = this.add.text(this.scale.width/2, 320, "Paytable", {fontFamily:"Sava", color: "#632e2e", fontSize: "60px"}).setOrigin(0.5)
        ...
        const rulesDescription = this.add.text(this.scale.width/2, 570, `${initData.UIData.symbols[13].description}`, {fontFamily:"Sava", color: "#632e2e", fontSize: "40px", wordWrap:{ width: 1100, useAdvancedWrap: true }}).setOrigin(0.5)
